...
public class TourController {
    ...
    @Operation(summary = "Save in system un tour based in list of hotels and list of flihgts ")
    @PostMapping
    ...
    @Operation(summary = "Remove a ticket form tour   ")
    ...
    @Operation(summary = "Add a ticket form tou ")
    ...
    @Operation(summary = "Remove a Reservation form tour   ")
    ...
    @Operation(summary = "Add a reservation form tour   ")
